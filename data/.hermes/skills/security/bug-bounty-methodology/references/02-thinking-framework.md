...
### DO NOT STOP — Primary Directive

- Authorization at engagement start covers the ENTIRE engagement
- Discipline rules are about correctness of FINDINGS, not throttling of EFFORT
- "Stop at PoC" = stop ESCALATING, not stop TESTING
- Never retract a finding on first reproducibility failure
